...
<?php
    ...
    $subject = $_POST["subject"]; //전달받아서 $subject 변수에 저장
	...
	$regist_day = date("Y-m-d (H:i)"); //현재 년, 월, 일, 시, 분을 저장
	...
	if ($upfile_name && !$upfile_error)
	{
		...
		//업로드 파일의 크기제한
		//업로드 파일의 크기가 약 1MB를 초과하면 경고메세지 출력
	...
	//아이디, 사용자 이름, 제목, 내용, 날짜, 히트, 파일이름, 파일타입, 실제 업로드 파일명
	...
	/* location.href에 board_list.php를 설정하여 목록페이지로 이동하도록 */
	echo "
		<script>
